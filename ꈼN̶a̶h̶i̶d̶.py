...
--------------------------------------------------
>>  Owner       :  𝐍 𝐚 𝐡 𝐢 𝐝 👿
>>  Facebook :  Mԃ ɳαԋυԃ ԋαʂαɳ　ツ
>>  Version     : 11
>>  Team❤    : ◤ᴛᴇᴀᴍ☯ 𝘏𝘢𝘤𝘬𝘪𝘯𝘨 𝘣𝘰𝘺 😈
>>  github   :  𝙝𝙖𝙘𝙠𝙞𝙣𝙜𝙗𝙤𝙮𝙟𝙧? 
--------------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------------')
...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> Hackingboy TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/mdnahidhasan008?mibextid=ZbWKwL');menu()
			elif xd in ['0','00']:
				exit()
			else:
